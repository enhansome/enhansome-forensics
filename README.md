...
* :star: [ForensicArtifacts.com Artifact Repository](https://github.com/ForensicArtifacts/artifacts) ⭐ 1,271 | 🐛 44 | 🌐 Python | 📅 2026-07-31 - Machine-readable knowledge base of forensic artifacts
...
* :star: [The Sleuth Kit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,145 | 🐛 481 | 🌐 C | 📅 2026-08-19 - Tools for low level forensic analysis
* [IPED - Indexador e Processador de Evidências Digitais](https://github.com/sepinf-inc/IPED) ⭐ 2,752 | 🐛 379 | 🌐 Java | 📅 2026-09-09 - Brazilian Federal Police Tool for Forensic Investigations
...
* [IntelMQ](https://github.com/certtools/intelmq) ⭐ 1,134 | 🐛 253 | 🌐 Python | 📅 2026-04-28 - IntelMQ collects and processes security feeds
* [Kuiper](https://github.com/DFIRKuiper/Kuiper) ⭐ 905 | 🐛 12 | 🌐 JavaScript | 📅 2024-10-12 - Digital Investigation Platform
* [turbinia](https://github.com/google/turbinia) ⭐ 793 | 🐛 104 | 🌐 Python | 📅 2026-08-09 - Turbinia is an open-source framework for deploying, managing, and running forensic workloads on cloud platforms
...
* [osquery](https://github.com/osquery/osquery) ⭐ 23,556 | 🐛 642 | 🌐 C++ | 📅 2026-09-09 - SQL powered operating system analytics
...
* [UAC](https://github.com/tclahr/uac) ⭐ 1,449 | 🐛 7 | 🌐 Shell | 📅 2026-09-09 - UAC (Unix-like Artifacts Collector) is a Live Response collection script for Incident Response that makes use of native binaries and tools to automate the collection of AIX, Android, ESXi, FreeBSD, Linux, macOS, NetBSD, NetScaler, OpenBSD and Solaris systems artifacts.
...
* [Loki](https://github.com/Neo23x0/Loki) ⭐ 3,788 | 🐛 18 | 🌐 Python | 📅 2026-01-12 - Simple IOC and Incident Response Scanner
...
* [Velociraptor](https://github.com/Velocidex/velociraptor) ⭐ 4,239 | 🐛 80 | 🌐 Go | 📅 2026-09-09 - Velociraptor is a tool for collecting host based state information using Velocidex Query Language (VQL) queries
* [LiME](https://github.com/jtsylve/LiME) ⭐ 2,031 | 🐛 35 | 🌐 C | 📅 2026-04-05 - Loadable Kernel Module (LKM), which allows the acquisition of volatile memory from Linux and Linux-based devices, formerly called DMD
* [AVML](https://github.com/microsoft/avml) ⭐ 1,119 | 🐛 5 | 🌐 Rust | 📅 2026-08-19 - A portable volatile memory acquisition tool for Linux
* [UFADE](https://github.com/prosch88/UFADE) ⭐ 529 | 🐛 3 | 🌐 Python | 📅 2026-09-09 - Extract files from iOS devices on Linux and MacOS. Mostly a wrapper for pymobiledevice3. Creates iTunes-style backups and advanced logical backups.
...
* [Acquire](https://github.com/fox-it/acquire) ⭐ 122 | 🐛 54 | 🌐 Python | 📅 2026-08-12 - Acquire is a tool to quickly gather forensic artifacts from disk images or a live system into a lightweight container
* [FIT](https://github.com/fit-project/fit) ⭐ 106 | 🐛 1 | 🌐 Python | 📅 2026-03-06 - Forensic acquisition of web pages, emails, social media, etc.
* [ALEX](https://github.com/prosch88/ALEX) ⭐ 60 | 🐛 1 | 🌐 Python | 📅 2026-08-31 - Extract files from ADB devices on Windows, Linux and MacOS. Mostly a wrapper for adbutils.
...
* [floss](https://github.com/mandiant/flare-floss) ⭐ 4,146 | 🐛 111 | 🌐 Python | 📅 2026-09-08 - Static analysis tool to automatically deobfuscate strings from malware binaries
* [bulk\_extractor](https://github.com/simsong/bulk_extractor) ⭐ 1,420 | 🐛 67 | 🌐 C++ | 📅 2026-09-01 - Extracts information such as email addresses, creditcard numbers and histrograms from disk images
...
* [MemProcFS](https://github.com/ufrisk/MemProcFS) ⭐ 4,324 | 🐛 4 | 🌐 C | 📅 2026-09-08 - An easy and convenient way of accessing physical memory as files a virtual file system.
...
* [RustNet](https://github.com/domcyrus/rustnet) ⭐ 5,012 | 🐛 19 | 🌐 Rust | 📅 2026-09-09 - A cross-platform network monitoring terminal UI providing real-time visibility into network connections
* [Kismet](https://github.com/kismetwireless/kismet) ⭐ 2,216 | 🐛 207 | 🌐 C++ | 📅 2026-09-01 - A passive wireless sniffer
...
* [Hayabusa](https://github.com/Yamato-Security/hayabusa) ⭐ 3,339 | 🐛 18 | 🌐 Rust | 📅 2026-09-05 - A sigma-based threat hunting and fast forensics timeline generator for Windows event logs.
...
* [NTFSTool](https://github.com/thewhiteninja/ntfstool) ⭐ 626 | 🐛 6 | 🌐 C++ | 📅 2026-06-26 - Complete NTFS forensics tool
...
* [MFTExtractor](https://github.com/aarsakian/FileSystemForensics) ⭐ 18 | 🐛 1 | 🌐 Go | 📅 2026-09-02 - MFT-Parser
...
* :zzz: [OSXAuditor](https://github.com/jipegit/OSXAuditor) ⭐ 3,132 | 🐛 8 | 🌐 JavaScript | 📅 2020-07-27
* [APFS Fuse](https://github.com/sgan81/apfs-fuse) ⭐ 2,142 | 🐛 126 | 🌐 C++ | 📅 2024-08-13 - A read-only FUSE driver for the new Apple File System
* :package: [OSX Collect](https://github.com/YelpArchive/osxcollector) ⚠️ Archived
* [mac\_apt (macOS Artifact Parsing Tool)](https://github.com/ydkhatri/mac_apt) ⭐ 1,081 | 🐛 8 | 🌐 Python | 📅 2026-08-21 - Extracts forensic artifacts from disk images or live machines
...
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,732 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-09 - An automated, all-in-one mobile application (Android/iOS/Windows) pen-testing, malware analysis and security assessment framework capable of performing static and dynamic analysis.
* :zzz: [Andriller](https://github.com/den4uk/andriller) ⭐ 1,603 | 🐛 11 | 🌐 Python | 📅 2022-06-27 - A software utility with a collection of forensic tools for smartphones
* [iLEAPP](https://github.com/abrignoni/iLEAPP) ⭐ 1,189 | 🐛 63 | 🌐 Python | 📅 2026-09-09 - An iOS Logs, Events, And Plists Parser
* [ALEAPP](https://github.com/abrignoni/ALEAPP) ⭐ 902 | 🐛 46 | 🌐 Python | 📅 2026-09-09 - An Android Logs Events and Protobuf Parser
...
* [hindsight](https://github.com/RyanDFIR/hindsight) ⭐ 1,505 | 🐛 36 | 🌐 Python | 📅 2026-09-07 - Internet history forensics for Google Chrome/Chromium
* [unfurl](https://github.com/RyanDFIR/unfurl) ⭐ 764 | 🐛 32 | 🌐 Python | 📅 2026-09-03 - Extract and visualize data from URLs
...
* :star: [plaso](https://github.com/log2timeline/plaso) ⭐ 2,151 | 🐛 276 | 🌐 Python | 📅 2026-08-28 - Extract timestamps from various files and aggregate them
...
* [libewf](https://github.com/libyal/libewf) ⭐ 315 | 🐛 13 | 🌐 C | 📅 2026-07-16 - Libewf is a library and some tools to access the Expert Witness Compression Format (EWF, E01)
...
* [iris](https://github.com/dfir-iris/iris-web) ⭐ 1,559 | 🐛 431 | 🌐 Python | 📅 2026-08-24 - Collaborative Incident Response platform
...
* [sherloq](https://github.com/GuidoBartoli/sherloq) ⭐ 3,200 | 🐛 25 | 🌐 Perl | 📅 2026-07-16 - An open-source digital photographic image forensic toolset
...
* :zzz: [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,630 | 🐛 26 | 🌐 C# | 📅 2022-12-08 - FOCA is a tool used mainly to find metadata and hidden information in the documents
* [oletools](https://github.com/decalage2/oletools) ⭐ 3,412 | 🐛 518 | 🌐 Python | 📅 2026-02-14 - Tools to analyze Microsoft OLE2 files and MS Office documents for malware analysis and forensics
* :zzz: [Metagoofil](https://github.com/laramies/metagoofil) ⭐ 1,318 | 🐛 19 | 🌐 Python | 📅 2024-03-21 - Metadata harvester for extracting metadata from public documents
* [mat2](https://github.com/jvoisin/mat2) ⭐ 362 | 🐛 2 | 🌐 Python | 📅 2026-09-09 - Metadata removal tool, supporting a wide range of commonly used file formats
...
* [Zsteg](https://github.com/zed-0xff/zsteg) ⭐ 1,623 | 🐛 6 | 🌐 Ruby | 📅 2026-01-28 - Detect steganography hidden in PNG and BMP files
* :zzz: [Steghide](https://github.com/StegHigh/steghide) ⭐ 776 | 🐛 4 | 🌐 C++ | 📅 2024-02-20 - is a steganography program that hides data in various kinds of image and audio files
...
* [Forensics CTFs](https://github.com/apsdehal/awesome-ctf/blob/master/README.md#forensics) ⭐ 11,839 | 🐛 67 | 🌐 JavaScript | 📅 2024-07-22
* :zzz: [MemLabs](https://github.com/stuxnet999/MemLabs) ⭐ 1,894 | 🐛 0 | 🌐 Shell | 📅 2021-03-08
...
* [Pentesting](https://github.com/enaqx/awesome-pentest) ⭐ 27,156 | 🐛 118 | 📅 2026-07-25
* [Hacking](https://github.com/carpedm20/awesome-hacking) ⭐ 17,024 | 🐛 72 | 📅 2024-06-02
* [Security](https://github.com/sbilly/awesome-security) ⭐ 14,841 | 🐛 323 | 📅 2026-01-11
* [Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,184 | 🐛 25 | 📅 2024-06-07
* [CTFs](https://github.com/apsdehal/awesome-ctf) ⭐ 11,839 | 🐛 67 | 🌐 JavaScript | 📅 2024-07-22
* [Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,550 | 🐛 23 | 🌐 Python | 📅 2026-06-01
* [Android Security](https://github.com/ashishb/android-security-awesome) ⭐ 9,679 | 🐛 0 | 🌐 Makefile | 📅 2026-09-07
* [Incident-Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,376 | 🐛 80 | 📅 2026-07-15
* [AppSec](https://github.com/paragonie/awesome-appsec) ⭐ 7,051 | 🐛 40 | 🌐 PHP | 📅 2025-02-22
* [Infosec](https://github.com/onlurking/awesome-infosec) ⭐ 5,740 | 🐛 18 | 📅 2026-08-28
* [YARA](https://github.com/pedramamini/awesome-yara) ⭐ 4,271 | 🐛 2 | 📅 2026-06-15
* [Social Engineering](https://github.com/giuliacassara/awesome-social-engineering) ⭐ 4,253 | 🐛 11 | 📅 2023-04-05
