...
* :star: [ForensicArtifacts.com Artifact Repository](https://github.com/ForensicArtifacts/artifacts) ⭐ 1,272 | 🐛 44 | 🌐 Python | 📅 2026-07-31 - Machine-readable knowledge base of forensic artifacts
...
* :zzz: [SANS Investigative Forensics Toolkit (sift)](https://github.com/teamdfir/sift) ⭐ 551 | 🐛 20 | 📅 2024-02-14 - Linux distribution for forensic analysis
* [bitscout](https://github.com/vitaly-kamluk/bitscout) ⭐ 480 | 🐛 0 | 🌐 Shell | 📅 2025-03-21 - LiveCD/LiveUSB for remote forensic acquisition and analysis
...
* :star: [The Sleuth Kit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,147 | 🐛 483 | 🌐 C | 📅 2026-08-19 - Tools for low level forensic analysis
* [IPED - Indexador e Processador de Evidências Digitais](https://github.com/sepinf-inc/IPED) ⭐ 2,903 | 🐛 384 | 🌐 Java | 📅 2026-09-10 - Brazilian Federal Police Tool for Forensic Investigations
* :zzz: [PowerForensics](https://github.com/Invoke-IR/PowerForensics) ⭐ 1,444 | 🐛 64 | 🌐 C# | 📅 2023-11-16 - PowerForensics is a framework for live disk forensic analysis
...
* [IntelMQ](https://github.com/certtools/intelmq) ⭐ 1,135 | 🐛 255 | 🌐 Python | 📅 2026-04-28 - IntelMQ collects and processes security feeds
* [Kuiper](https://github.com/DFIRKuiper/Kuiper) ⭐ 906 | 🐛 12 | 🌐 JavaScript | 📅 2024-10-12 - Digital Investigation Platform
* [turbinia](https://github.com/google/turbinia) ⭐ 794 | 🐛 104 | 🌐 Python | 📅 2026-08-09 - Turbinia is an open-source framework for deploying, managing, and running forensic workloads on cloud platforms
...
* :zzz: [dexter](https://github.com/coinbase/dexter) ⭐ 127 | 🐛 10 | 🌐 Go | 📅 2019-06-21 - Dexter is a forensics acquisition framework designed to be extensible and secure
* [Wombat Forensics](https://github.com/pjrinaldi/wombatforensics) ⭐ 50 | 🐛 58 | 📅 2024-07-19 - Forensic GUI tool
* [AIFT](https://github.com/FlipForensics/AIFT) ⭐ 44 | 🐛 0 | 🌐 Python | 📅 2026-06-13 - AIFT (AI Forensic Triage) parses evidence using dissect and generates AI-assisted forensic reports.
...
* [osquery](https://github.com/osquery/osquery) ⭐ 23,564 | 🐛 662 | 🌐 C++ | 📅 2026-09-09 - SQL powered operating system analytics
* [grr](https://github.com/google/grr) ⭐ 5,087 | 🐛 191 | 🌐 Python | 📅 2026-05-12 - GRR Rapid Response: remote live forensics for incident response
...
* [Loki](https://github.com/Neo23x0/Loki) ⭐ 3,790 | 🐛 18 | 🌐 Python | 📅 2026-01-12 - Simple IOC and Incident Response Scanner
...
* [Velociraptor](https://github.com/Velocidex/velociraptor) ⭐ 4,243 | 🐛 81 | 🌐 Go | 📅 2026-09-10 - Velociraptor is a tool for collecting host based state information using Velocidex Query Language (VQL) queries
* [LiME](https://github.com/jtsylve/LiME) ⭐ 2,033 | 🐛 35 | 🌐 C | 📅 2026-04-05 - Loadable Kernel Module (LKM), which allows the acquisition of volatile memory from Linux and Linux-based devices, formerly called DMD
* [AVML](https://github.com/microsoft/avml) ⭐ 1,120 | 🐛 6 | 🌐 Rust | 📅 2026-09-11 - A portable volatile memory acquisition tool for Linux
* [UFADE](https://github.com/prosch88/UFADE) ⭐ 533 | 🐛 3 | 🌐 Python | 📅 2026-09-09 - Extract files from iOS devices on Linux and MacOS. Mostly a wrapper for pymobiledevice3. Creates iTunes-style backups and advanced logical backups.
...
* [Fuji](https://github.com/Lazza/Fuji/) ⭐ 297 | 🐛 7 | 🌐 Python | 📅 2026-06-02 - MacOS forensic acquisition made simple. It creates full file system copies or targeted collection of Mac computers.
* [ForensicMiner](https://github.com/securityjoes/ForensicMiner) ⭐ 165 | 🐛 2 | 🌐 PowerShell | 📅 2025-04-06 - A PowerShell-based DFIR automation tool, for artifact and evidence collection on Windows machines.
* [Acquire](https://github.com/fox-it/acquire) ⭐ 122 | 🐛 59 | 🌐 Python | 📅 2026-08-12 - Acquire is a tool to quickly gather forensic artifacts from disk images or a live system into a lightweight container
* [FIT](https://github.com/fit-project/fit) ⭐ 106 | 🐛 1 | 🌐 Python | 📅 2026-03-06 - Forensic acquisition of web pages, emails, social media, etc.
* [ALEX](https://github.com/prosch88/ALEX) ⭐ 62 | 🐛 1 | 🌐 Python | 📅 2026-09-10 - Extract files from ADB devices on Windows, Linux and MacOS. Mostly a wrapper for adbutils.
...
* [floss](https://github.com/mandiant/flare-floss) ⭐ 4,147 | 🐛 117 | 🌐 Python | 📅 2026-09-13 - Static analysis tool to automatically deobfuscate strings from malware binaries
* [bulk\_extractor](https://github.com/simsong/bulk_extractor) ⭐ 1,421 | 🐛 66 | 🌐 C++ | 📅 2026-09-01 - Extracts information such as email addresses, creditcard numbers and histrograms from disk images
...
* [MemProcFS](https://github.com/ufrisk/MemProcFS) ⭐ 4,330 | 🐛 5 | 🌐 C | 📅 2026-09-08 - An easy and convenient way of accessing physical memory as files a virtual file system.
...
* [RustNet](https://github.com/domcyrus/rustnet) ⭐ 5,020 | 🐛 19 | 🌐 Rust | 📅 2026-09-09 - A cross-platform network monitoring terminal UI providing real-time visibility into network connections
* [Kismet](https://github.com/kismetwireless/kismet) ⭐ 2,218 | 🐛 207 | 🌐 C++ | 📅 2026-09-13 - A passive wireless sniffer
...
* [Hayabusa](https://github.com/Yamato-Security/hayabusa) ⭐ 3,345 | 🐛 18 | 🌐 Rust | 📅 2026-09-12 - A sigma-based threat hunting and fast forensics timeline generator for Windows event logs.
* [LogonTracer](https://github.com/JPCERTCC/LogonTracer) ⭐ 3,235 | 🐛 22 | 🌐 Python | 📅 2026-08-02 - Investigate malicious Windows logon by visualizing and analyzing Windows event log
* :zzz: [Beagle](https://github.com/yampelo/beagle) ⭐ 1,354 | 🐛 44 | 🌐 Python | 📅 2022-12-13 -  Transform data sources and logs into graphs
* [RegRipper3.0](https://github.com/keydet89/RegRipper3.0) ⭐ 717 | 🐛 9 | 🌐 Perl | 📅 2026-05-27 - RegRipper is an open source Perl tool for parsing the Registry and presenting it for analysis
...
* [MFTExtractor](https://github.com/aarsakian/FileSystemForensics) ⭐ 18 | 🐛 1 | 🌐 Go | 📅 2026-09-13 - MFT-Parser
...
* :zzz: [OSXAuditor](https://github.com/jipegit/OSXAuditor) ⭐ 3,132 | 🐛 9 | 🌐 JavaScript | 📅 2020-07-27
* [APFS Fuse](https://github.com/sgan81/apfs-fuse) ⭐ 2,146 | 🐛 126 | 🌐 C++ | 📅 2024-08-13 - A read-only FUSE driver for the new Apple File System
* :package: [OSX Collect](https://github.com/YelpArchive/osxcollector) ⚠️ Archived
* [mac\_apt (macOS Artifact Parsing Tool)](https://github.com/ydkhatri/mac_apt) ⭐ 1,083 | 🐛 9 | 🌐 Python | 📅 2026-08-21 - Extracts forensic artifacts from disk images or live machines
...
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,762 | 🐛 31 | 🌐 JavaScript | 📅 2026-09-09 - An automated, all-in-one mobile application (Android/iOS/Windows) pen-testing, malware analysis and security assessment framework capable of performing static and dynamic analysis.
* :zzz: [Andriller](https://github.com/den4uk/andriller) ⭐ 1,607 | 🐛 12 | 🌐 Python | 📅 2022-06-27 - A software utility with a collection of forensic tools for smartphones
* [iLEAPP](https://github.com/abrignoni/iLEAPP) ⭐ 1,254 | 🐛 63 | 🌐 Python | 📅 2026-09-13 - An iOS Logs, Events, And Plists Parser
* [ALEAPP](https://github.com/abrignoni/ALEAPP) ⭐ 911 | 🐛 43 | 🌐 Python | 📅 2026-09-13 - An Android Logs Events and Protobuf Parser
...
* :zzz: [MEAT](https://github.com/jfarley248/MEAT) ⭐ 169 | 🐛 2 | 🌐 Python | 📅 2020-05-21 - Perform different kinds of acquisitions on iOS devices
...
* :zzz: [dof (Docker Forensics Toolkit)](https://github.com/docker-forensics-toolkit/toolkit) ⭐ 113 | 🐛 1 | 🌐 Python | 📅 2024-02-18 - Extracts and interprets forensic artifacts from disk images of Docker Host systems

### Internet Artifacts

* [hindsight](https://github.com/RyanDFIR/hindsight) ⭐ 1,506 | 🐛 35 | 🌐 Python | 📅 2026-09-13 - Internet history forensics for Google Chrome/Chromium
* [unfurl](https://github.com/RyanDFIR/unfurl) ⭐ 764 | 🐛 32 | 🌐 Python | 📅 2026-09-10 - Extract and visualize data from URLs
...
* :star: [plaso](https://github.com/log2timeline/plaso) ⭐ 2,153 | 🐛 278 | 🌐 Python | 📅 2026-09-13 - Extract timestamps from various files and aggregate them
* [DFTimewolf](https://github.com/log2timeline/dftimewolf) ⭐ 353 | 🐛 4 | 🌐 Python | 📅 2026-09-03 - Framework for orchestrating forensic collection, processing and data export using GRR and Rekall
...
* [Disk Arbitrator](https://github.com/aburgh/Disk-Arbitrator) ⭐ 717 | 🐛 30 | 🌐 Objective-C | 📅 2025-08-25 - A Mac OS X forensic utility designed to help the user ensure correct forensic procedures are followed during imaging of a disk device
* [libewf](https://github.com/libyal/libewf) ⭐ 316 | 🐛 13 | 🌐 C | 📅 2026-07-16 - Libewf is a library and some tools to access the Expert Witness Compression Format (EWF, E01)
...
* [iris](https://github.com/dfir-iris/iris-web) ⭐ 1,560 | 🐛 432 | 🌐 Python | 📅 2026-08-24 - Collaborative Incident Response platform
...
* [sherloq](https://github.com/GuidoBartoli/sherloq) ⭐ 3,204 | 🐛 25 | 🌐 Perl | 📅 2026-07-16 - An open-source digital photographic image forensic toolset
* :zzz: [Ghiro](https://github.com/Ghirensics/ghiro) ⭐ 528 | 🐛 18 | 🌐 Python | 📅 2016-09-15 - A fully automated tool designed to run forensics analysis over a massive amount of images

### Metadata Forensics

* :zzz: [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,634 | 🐛 26 | 🌐 C# | 📅 2022-12-08 - FOCA is a tool used mainly to find metadata and hidden information in the documents
* [oletools](https://github.com/decalage2/oletools) ⭐ 3,413 | 🐛 518 | 🌐 Python | 📅 2026-02-14 - Tools to analyze Microsoft OLE2 files and MS Office documents for malware analysis and forensics
* :zzz: [Metagoofil](https://github.com/laramies/metagoofil) ⭐ 1,319 | 🐛 19 | 🌐 Python | 📅 2024-03-21 - Metadata harvester for extracting metadata from public documents
* [mat2](https://github.com/jvoisin/mat2) ⭐ 366 | 🐛 2 | 🌐 Python | 📅 2026-09-09 - Metadata removal tool, supporting a wide range of commonly used file formats
...
* [Zsteg](https://github.com/zed-0xff/zsteg) ⭐ 1,625 | 🐛 6 | 🌐 Ruby | 📅 2026-01-28 - Detect steganography hidden in PNG and BMP files
* :zzz: [Steghide](https://github.com/StegHigh/steghide) ⭐ 775 | 🐛 4 | 🌐 C++ | 📅 2024-02-20 - is a steganography program that hides data in various kinds of image and audio files
...
* [Forensics CTFs](https://github.com/apsdehal/awesome-ctf/blob/master/README.md#forensics) ⭐ 11,843 | 🐛 67 | 🌐 JavaScript | 📅 2024-07-22
* :zzz: [MemLabs](https://github.com/stuxnet999/MemLabs) ⭐ 1,895 | 🐛 0 | 🌐 Shell | 📅 2021-03-08
...
* [BlueTeam.Lab](https://github.com/op7ic/BlueTeam.Lab) ⭐ 189 | 🐛 1 | 🌐 Jinja | 📅 2024-11-20 - Blue Team detection lab created with Terraform and Ansible in Azure.

## Related Awesome Lists

* [Pentesting](https://github.com/enaqx/awesome-pentest) ⭐ 27,190 | 🐛 119 | 📅 2026-07-25
* [Hacking](https://github.com/carpedm20/awesome-hacking) ⭐ 17,061 | 🐛 73 | 📅 2024-06-02
* [Security](https://github.com/sbilly/awesome-security) ⭐ 14,852 | 🐛 329 | 📅 2026-01-11
* [Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,193 | 🐛 25 | 📅 2024-06-07
* [CTFs](https://github.com/apsdehal/awesome-ctf) ⭐ 11,843 | 🐛 67 | 🌐 JavaScript | 📅 2024-07-22
* [Honeypots](https://github.com/paralax/awesome-honeypots) ⭐ 10,558 | 🐛 25 | 🌐 Python | 📅 2026-06-01
* [Android Security](https://github.com/ashishb/android-security-awesome) ⭐ 9,688 | 🐛 0 | 🌐 Makefile | 📅 2026-09-07
* [Incident-Response](https://github.com/meirwah/awesome-incident-response) ⭐ 9,384 | 🐛 82 | 📅 2026-07-15
* [AppSec](https://github.com/paragonie/awesome-appsec) ⭐ 7,055 | 🐛 41 | 🌐 PHP | 📅 2025-02-22
* [Infosec](https://github.com/onlurking/awesome-infosec) ⭐ 5,744 | 🐛 18 | 📅 2026-08-28
* [YARA](https://github.com/pedramamini/awesome-yara) ⭐ 4,272 | 🐛 2 | 📅 2026-06-15
* [Social Engineering](https://github.com/giuliacassara/awesome-social-engineering) ⭐ 4,259 | 🐛 11 | 📅 2023-04-05
