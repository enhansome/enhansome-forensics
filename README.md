...
* :zzz: [SANS Investigative Forensics Toolkit (sift)](https://github.com/teamdfir/sift) ⭐ 551 | 🐛 19 | 📅 2024-02-14 - Linux distribution for forensic analysis
...
* :star: [The Sleuth Kit](https://github.com/sleuthkit/sleuthkit) ⭐ 3,141 | 🐛 479 | 🌐 C | 📅 2026-08-19 - Tools for low level forensic analysis
* [IPED - Indexador e Processador de Evidências Digitais](https://github.com/sepinf-inc/IPED) ⭐ 2,738 | 🐛 375 | 🌐 Java | 📅 2026-09-03 - Brazilian Federal Police Tool for Forensic Investigations
...
* [osquery](https://github.com/osquery/osquery) ⭐ 23,537 | 🐛 635 | 🌐 C++ | 📅 2026-08-25 - SQL powered operating system analytics
...
* [Velociraptor](https://github.com/Velocidex/velociraptor) ⭐ 4,231 | 🐛 82 | 🌐 Go | 📅 2026-09-03 - Velociraptor is a tool for collecting host based state information using Velocidex Query Language (VQL) queries
* [LiME](https://github.com/jtsylve/LiME) ⭐ 2,029 | 🐛 35 | 🌐 C | 📅 2026-04-05 - Loadable Kernel Module (LKM), which allows the acquisition of volatile memory from Linux and Linux-based devices, formerly called DMD
* [AVML](https://github.com/microsoft/avml) ⭐ 1,119 | 🐛 5 | 🌐 Rust | 📅 2026-08-19 - A portable volatile memory acquisition tool for Linux
* [UFADE](https://github.com/prosch88/UFADE) ⭐ 524 | 🐛 3 | 🌐 Python | 📅 2026-09-01 - Extract files from iOS devices on Linux and MacOS. Mostly a wrapper for pymobiledevice3. Creates iTunes-style backups and advanced logical backups.
...
* [ALEX](https://github.com/prosch88/ALEX) ⭐ 59 | 🐛 1 | 🌐 Python | 📅 2026-08-31 - Extract files from ADB devices on Windows, Linux and MacOS. Mostly a wrapper for adbutils.
...
* [floss](https://github.com/mandiant/flare-floss) ⭐ 4,145 | 🐛 113 | 🌐 Python | 📅 2026-09-03 - Static analysis tool to automatically deobfuscate strings from malware binaries
* [bulk\_extractor](https://github.com/simsong/bulk_extractor) ⭐ 1,418 | 🐛 67 | 🌐 C++ | 📅 2026-09-01 - Extracts information such as email addresses, creditcard numbers and histrograms from disk images
...
* [MemProcFS](https://github.com/ufrisk/MemProcFS) ⭐ 4,315 | 🐛 9 | 🌐 C | 📅 2026-08-25 - An easy and convenient way of accessing physical memory as files a virtual file system.
...
* [RustNet](https://github.com/domcyrus/rustnet) ⭐ 4,993 | 🐛 21 | 🌐 Rust | 📅 2026-09-03 - A cross-platform network monitoring terminal UI providing real-time visibility into network connections
* [Kismet](https://github.com/kismetwireless/kismet) ⭐ 2,213 | 🐛 206 | 🌐 C++ | 📅 2026-09-01 - A passive wireless sniffer
...
* [Hayabusa](https://github.com/Yamato-Security/hayabusa) ⭐ 3,335 | 🐛 19 | 🌐 Rust | 📅 2026-09-04 - A sigma-based threat hunting and fast forensics timeline generator for Windows event logs.
...
* :zzz: [Beagle](https://github.com/yampelo/beagle) ⭐ 1,352 | 🐛 44 | 🌐 Python | 📅 2022-12-13 -  Transform data sources and logs into graphs
* [RegRipper3.0](https://github.com/keydet89/RegRipper3.0) ⭐ 716 | 🐛 9 | 🌐 Perl | 📅 2026-05-27 - RegRipper is an open source Perl tool for parsing the Registry and presenting it for analysis
...
* [NTFSTool](https://github.com/thewhiteninja/ntfstool) ⭐ 625 | 🐛 6 | 🌐 C++ | 📅 2026-06-26 - Complete NTFS forensics tool
...
* [APFS Fuse](https://github.com/sgan81/apfs-fuse) ⭐ 2,140 | 🐛 125 | 🌐 C++ | 📅 2024-08-13 - A read-only FUSE driver for the new Apple File System
* :package: [OSX Collect](https://github.com/YelpArchive/osxcollector) ⚠️ Archived
* [mac\_apt (macOS Artifact Parsing Tool)](https://github.com/ydkhatri/mac_apt) ⭐ 1,080 | 🐛 8 | 🌐 Python | 📅 2026-08-21 - Extracts forensic artifacts from disk images or live machines
...
* [MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,698 | 🐛 30 | 🌐 JavaScript | 📅 2026-09-02 - An automated, all-in-one mobile application (Android/iOS/Windows) pen-testing, malware analysis and security assessment framework capable of performing static and dynamic analysis.
* :zzz: [Andriller](https://github.com/den4uk/andriller) ⭐ 1,601 | 🐛 11 | 🌐 Python | 📅 2022-06-27 - A software utility with a collection of forensic tools for smartphones
* [iLEAPP](https://github.com/abrignoni/iLEAPP) ⭐ 1,186 | 🐛 62 | 🌐 Python | 📅 2026-09-03 - An iOS Logs, Events, And Plists Parser
* [ALEAPP](https://github.com/abrignoni/ALEAPP) ⭐ 899 | 🐛 47 | 🌐 Python | 📅 2026-09-03 - An Android Logs Events and Protobuf Parser
...
* [hindsight](https://github.com/RyanDFIR/hindsight) ⭐ 1,501 | 🐛 6 | 🌐 Python | 📅 2026-09-03 - Internet history forensics for Google Chrome/Chromium
...
* :star: [plaso](https://github.com/log2timeline/plaso) ⭐ 2,146 | 🐛 276 | 🌐 Python | 📅 2026-08-28 - Extract timestamps from various files and aggregate them
...
* [Disk Arbitrator](https://github.com/aburgh/Disk-Arbitrator) ⭐ 715 | 🐛 30 | 🌐 Objective-C | 📅 2025-08-25 - A Mac OS X forensic utility designed to help the user ensure correct forensic procedures are followed during imaging of a disk device
...
* [iris](https://github.com/dfir-iris/iris-web) ⭐ 1,557 | 🐛 430 | 🌐 Python | 📅 2026-08-24 - Collaborative Incident Response platform
...
* [sherloq](https://github.com/GuidoBartoli/sherloq) ⭐ 3,196 | 🐛 25 | 🌐 Perl | 📅 2026-07-16 - An open-source digital photographic image forensic toolset
...
* :zzz: [FOCA](https://github.com/ElevenPaths/FOCA) ⭐ 3,625 | 🐛 26 | 🌐 C# | 📅 2022-12-08 - FOCA is a tool used mainly to find metadata and hidden information in the documents
* [oletools](https://github.com/decalage2/oletools) ⭐ 3,409 | 🐛 518 | 🌐 Python | 📅 2026-02-14 - Tools to analyze Microsoft OLE2 files and MS Office documents for malware analysis and forensics
...
* [mat2](https://github.com/jvoisin/mat2) ⭐ 355 | 🐛 2 | 🌐 Python | 📅 2026-08-30 - Metadata removal tool, supporting a wide range of commonly used file formats
...
* [Zsteg](https://github.com/zed-0xff/zsteg) ⭐ 1,621 | 🐛 6 | 🌐 Ruby | 📅 2026-01-28 - Detect steganography hidden in PNG and BMP files
* :zzz: [Steghide](https://github.com/StegHigh/steghide) ⭐ 774 | 🐛 4 | 🌐 C++ | 📅 2024-02-20 - is a steganography program that hides data in various kinds of image and audio files
...
* [Forensics CTFs](https://github.com/apsdehal/awesome-ctf/blob/master/README.md#forensics) ⭐ 11,824 | 🐛 66 | 🌐 JavaScript | 📅 2024-07-22
...
* [Pentesting](https://github.com/enaqx/awesome-pentest) ⭐ 27,110 | 🐛 111 | 📅 2026-07-25
* [Hacking](https://github.com/carpedm20/awesome-hacking) ⭐ 17,001 | 🐛 70 | 📅 2024-06-02
* [Security](https://github.com/sbilly/awesome-security) ⭐ 14,825 | 🐛 323 | 📅 2026-01-11
* [Malware Analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,179 | 🐛 25 | 📅 2024-06-07
* [CTFs](https://github.com/apsdehal/awesome-ctf) ⭐ 11,824 | 🐛 66 | 🌐 JavaScript | 📅 2024-07-22
...
* [AppSec](https://github.com/paragonie/awesome-appsec) ⭐ 7,049 | 🐛 41 | 🌐 PHP | 📅 2025-02-22
* [Infosec](https://github.com/onlurking/awesome-infosec) ⭐ 5,738 | 🐛 18 | 📅 2026-08-28
* [YARA](https://github.com/pedramamini/awesome-yara) ⭐ 4,269 | 🐛 2 | 📅 2026-06-15
* [Social Engineering](https://github.com/giuliacassara/awesome-social-engineering) ⭐ 4,253 | 🐛 10 | 📅 2023-04-05
